...
AxisAlignedBoundingBox::AxisAlignedBoundingBox(Object& _obj) : BoundingVolume(_obj), obj(_obj) 
{
...
AxisAlignedBoundingBox::AxisAlignedBoundingBox(const std::vector < std::pair<Object*, glm::vec3>>& _obj) : BoundingVolume(*_obj.front().first), obj(*_obj.front().first)
{
...
void AxisAlignedBoundingBox::Update(float dt, glm::vec3 offset = glm::vec3(0,0,0))
{
